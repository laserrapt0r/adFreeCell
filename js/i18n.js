...
(function () {
  ...
  var STRINGS = {
    de: {
      ...
      colorblind: 'Farbenblind-freundlich', colorblindHint: 'Kräftigeres Rot, klar von Schwarz unterscheidbar',
    ...
    en: {
      ...
      colorblind: 'Colorblind-friendly', colorblindHint: 'Brighter red, clearly distinct from black',
    ...
    es: {
      ...
      colorblind: 'Apto para daltónicos', colorblindHint: 'Rojo más vivo, distinto del negro',
    ...
    fr: {
      ...
      colorblind: 'Adapté au daltonisme', colorblindHint: 'Rouge plus vif, distinct du noir',
    ...
    it: {
      ...
      colorblind: 'Adatto ai daltonici', colorblindHint: 'Rosso più vivo, distinto dal nero',
